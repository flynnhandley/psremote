...
func (hvc *HypervRemote) GetVirtualMachineNetworkAdapterAddress(vmName string, adapterName string) (string, error) {
...
// NewVhd ...
func (hvc *HypervRemote) NewVhd(vmID string, vhdName string, diskSize int64) (string, error) {
...
// NewDiskFromImagePath ...
func (hvc *HypervRemote) NewDiskFromImagePath(vmID string, vhdName string, imagePath string) (string, error) {
...
// NewDiskFromImageURL ...
func (hvc *HypervRemote) NewDiskFromImageURL(vmID string, vhdName string, imageURL string) (string, error) {
...
// NewDifferencingDisk ...
func (hvc *HypervRemote) NewDifferencingDisk(vmID string, vhdName string, diffParentPath string) (string, error) {
...
func (hvc *HypervRemote) CreateVirtualMachine(vmName string, path string, ramMB int64, switchName string, generation int) (string, error) {
...
// SetVirtualMachineVirtualizationExtensions ...
func (hvc *HypervRemote) SetVirtualMachineVirtualizationExtensions(vmName string, enableVirtualizationExtensions bool) error {
	...
	params := map[string]string{
		"vmName": vmName,
		"exposeVirtualizationExtensionsString": exposeVirtualizationExtensionsString}
	_, err := hvc.Ps.OutputWinRm(script, params)
	return err
}

// SetVirtualMachineDynamicMemory ...
func (hvc *HypervRemote) SetVirtualMachineDynamicMemory(vmName string, enableDynamicMemory bool) error {
	...
	params := map[string]string{
		"vmName":                    vmName,
		"enableDynamicMemoryString": enableDynamicMemoryString}
	_, err := hvc.Ps.OutputWinRm(script, params)
	return err
}

// SetVirtualMachineMacSpoofing ...
func (hvc *HypervRemote) SetVirtualMachineMacSpoofing(vmName string, enableMacSpoofing bool) error {
	...
	params := map[string]string{
		"vmName":                  vmName,
		"enableMacSpoofingString": enableMacSpoofingString}
	_, err := hvc.Ps.OutputWinRm(script, params)
	return err
}

// SetVirtualMachineSecureBoot ...
func (hvc *HypervRemote) SetVirtualMachineSecureBoot(vmName string, enableSecureBoot bool, secureBootTemplate string) error {

	var script = `
		[string]$vmName = $using:vmName
		[string]$enableSecureBoot = $using:enableSecureBoot
		[string]$secureBootTemplate = $using:secureBootTemplate
		Set-VMFirmware -VMName $vmName -EnableSecureBoot $enableSecureBoot -SecureBootTemplate $secureBootTemplate
	`
	...
	params := map[string]string{
		"vmName":                 vmName,
		"enableSecureBootString": enableSecureBootString,
...
// AddVMNetworkAdapter ...
func (hvc *HypervRemote) AddVMNetworkAdapter(vmID string, adapterName string, switchName string, vlanID string) error {

	var script = `
		[string]$adapterName = $using:adapterName
		[string]$switchName = $using:switchName
		...
		$VM | Add-VMNetworkAdapter -Name "$adapterName" -SwitchName "$switchName"
		...
		if(($vlanID -ne $null) -and ($vlanID -ne "")){
			Set-VMNetworkAdapterVlan -VMNetworkAdapterName "$adapterName" -Access -VlanID $vlanID -VMName $VM.Name
		}
	`
...
// EnableVirtualMachineIntegrationService ...
...
func (hvc *HypervRemote) SetNetworkAdapterVlanID(switchName string, vlanID string) error {
	...
	params := map[string]string{
		"networkAdapterName": switchName,
		"vlanID":             vlanID}
	_, err := hvc.Ps.OutputWinRm(script, params)
	return err
}

// SetNetworkAdapterStaticMacAddress ...
func (hvc *HypervRemote) SetNetworkAdapterStaticMacAddress(vmName string, adapterName string, mac string) error {
...
func (hvc *HypervRemote) SetVirtualMachineVlanID(vmName string, vlanID string) error {
...
// GetExternalOnlineVirtualSwitch ...
...
// ConnectVirtualMachineNetworkAdapterToSwitch ...
...
// UntagVirtualMachineNetworkAdapterVlan ...
